...
export const TASK_PHASES = {
  ...
  triage: {
    ...
    allowedTools: ["list_files", "read_file", "search_files", "find_symbols", "find_definition", "find_references", "find_imports", "find_exports", "symbol_callers", "symbol_dependencies", "dependency_graph", "component_map", "route_map", "detect_test_runner", "git_status"],
    next: "plan"
  },
  plan: {
    status: "planning",
